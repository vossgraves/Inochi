...
import { ArrowRight, Blocks, Bot, Database, Gamepad2, Github, LineChart, LockKeyhole, MoveUpRight, ShieldCheck, Sparkles } from "lucide-react";
...
export default async function Home() {
  ...
  return <div className="site-frame">
    ...
    <main>
      ...
      <section className="final-cta"><div className="shell"><span className="eyebrow mono">Ready when your server is</span><h2>Make progression feel intentional.</h2><div className="final-actions"><Link className="button primary" href="/api/auth/invite">Add Inochi to your server<Bot size={16}/></Link><Link className="button ghost" href={dashboardHref}>{session ? "Open dashboard" : "Sign in with Discord"}<ArrowRight size={16}/></Link></div></div></section>
    </main>
    <footer className="site-footer shell"><div className="brand mono"><span className="brand-mark">生</span>Inochi</div><p>Independent, self-hosted Discord progression.</p><a href="https://github.com/vossgraves/Inochi" target="_blank" rel="noreferrer">Source</a></footer>
  </div>;
}
